...
---
#Question 1
#part a: Create a scatterplot for the level of sales on the number of shelf feet. Does the relationship appear linear?
...
#part b: Fit a linear regression equation to the data, regressing sales on the number of shelf feet. Does this fitted
...
#part c:Create a scatterplot that shows the relationship between the new set of variables. Does the
